...
# MIMIR local asset downloader (fixed Source Sans Pro)
...
# Helper to fetch a single static font file
fetch_static_font() {
    local family="$1"
    local weight="$2"
    local output_name="$3"
...
# Helper to fetch a variable font (single file)
fetch_variable_font() {
    local family="$1"
    local css_url="$2"
    local output_name="$3"

    echo "  Fetching variable $family ..."
    css=$(curl -s -L -A "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36" "$css_url")
...
echo ""
echo "Next steps:"
echo "  - Your privacy.html currently expects a single variable file 'source-sans-pro-variable.woff2'."
echo "  - To use the static files just downloaded, replace the @font-face block for Source Sans Pro with:"
echo ""
echo "    @font-face {"
echo "        font-family: 'Source Sans Pro';"
echo "        font-style: normal;"
echo "        font-weight: 300;"
echo "        src: url('../fonts/source-sans-300.woff2') format('woff2');"
echo "    }"
echo "    @font-face {"
echo "        font-family: 'Source Sans Pro';"
echo "        font-style: normal;"
echo "        font-weight: 400;"
echo "        src: url('../fonts/source-sans-400.woff2') format('woff2');"
echo "    }"
echo "    @font-face {"
echo "        font-family: 'Source Sans Pro';"
echo "        font-style: normal;"
echo "        font-weight: 600;"
echo "        src: url('../fonts/source-sans-600.woff2') format('woff2');"
echo "    }"
echo "    @font-face {"
echo "        font-family: 'Source Sans Pro';"
echo "        font-style: normal;"
echo "        font-weight: 700;"
echo "        src: url('../fonts/source-sans-700.woff2') format('woff2');"
echo "    }"
echo ""
echo "  - Alternatively, you can keep using the variable approach by switching to 'Source Sans 3'"
echo "    (the variable version) and adjust the family name in your CSS."
